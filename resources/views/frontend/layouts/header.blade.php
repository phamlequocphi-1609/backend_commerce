										...
										@if(session()->has('cart'))
											...
											@if(isset($cart) && is_array($cart))
												...
												@foreach($cart as $value)
													...
													@endphp
												@endforeach
													<i class="fa fa-shopping-cart"></i> {{$tong}} Cart</a></li>
                                      		  @endif
										@else
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="{{url('/product/searchAdvanced')}}">Search Advanced</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="pull-right">
							<form action="{{url('/product/search')}}" method="GET">
								<input placeholder="Search" name="search" style="  background: #F0F0E9;
									border: medium none;
									color: #B2B2B2;
									font-family: 'roboto';
									font-size: 12px;
									...
									padding-left: 10px;
									width: 155px;"/>
								<button type="submit" style=" background: #F0F0E9; border: none; height: 35px"><i class="fa fa-search"></i></button>
							</form>
						</div>
					</div>
				</div>
