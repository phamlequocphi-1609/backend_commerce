            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="shopper-info">
                        ...
                        <a class="btn btn-primary" href="{{url('/checkInformation')}}">Continue</a>
                    </div>
                </div>
            ...
            <table class="table table-condensed">
                ...
                @if(session()->has('cart'))
                    ...
                    @foreach($carts as $cart)
                        @php
                            $img = json_decode($cart['img']);
                        @endphp
                        <tr>
                            <td class="cart_product">
                                @if(isset($img[0]))
                                    <a href=""><img src="{{asset('upload/product/'.$img[0])}}" alt="" style="width: 100px"></a>
                                @endif				
                            </td>
                            ...
                            <td class="cart_delete">
                                <a class="cart_quantity_delete" href="#" id="{{$cart['id']}}"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @endif
